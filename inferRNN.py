#inferRNN
#can you fic all annotations in this file
#can you fix all typos in this file
...
def main():
    ...
    for i in DATASET_ITERATIONS:
        ...
        definitions_leammatized[f"POS_{i}"] = definitions_leammatized[f"POS_{i}"] * (1 - definitions_leammatized[f"NEG_{i}"])
        definitions_leammatized[f"NEG_{i}"] = definitions_leammatized[f"NEG_{i}"] * (1 - definitions_leammatized[f"POS_{i}"])
    ...
    # save dataframe definitions_leammatized in file srbsentiwordnet_3.csv in RES_DIR
    definitions_leammatized.to_csv(os.path.join(RES_DIR, "srbsentiwordnet_3.csv"))
